...
function update(state, itemIndex, newItemState) {
...
function renderList(state, element, itemDataAttr) {
...
function handleItemAdds(listElement, toggleIdentifier, itemDataAttr, state) {
